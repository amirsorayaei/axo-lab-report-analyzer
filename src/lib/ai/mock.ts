 ...
 * UI as demo mode: it ignores the uploaded document and returns the bundled
 * sample extraction. It exists so the interface, the pipeline and the UI can be
 * reviewed without a provider decision, never as a fallback for a failed call.
 */
